    ...
    return (
        <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? "max-md:hidden" : ""}`}>
            ...
            <div className='pb-5'>
                <div className="flex justify-between items-center">
                    ...
                    <div className="relative group">
                        ...
                        {/* Dropdown */}
                        <div className="absolute right-0 mt-2 w-40 bg-[#282142] rounded-lg shadow-lg p-3 hidden group-hover:block">
                            <p
                            ...
                            <p className="cursor-pointer text-sm hover:text-gray-300">
                                Logout
                            </p>
                        </div>
                    </div>
            ...
            <div className="flex flex-col">
                ...
                <div className={`relative flex items-center gap-2 p-2 pl-4 rounded cursor-pointer max-sm`}>
                    <img src={user?.profilePic || assets.avatar_icon} alt="ProfilePic" className='w-[35ppx] aspect-[1/1] rounded-full' />
